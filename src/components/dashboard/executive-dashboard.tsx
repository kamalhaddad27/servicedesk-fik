...
export function ExecutiveDashboard() {
  ...
  const {
    ...
    queryFn: () =>
      ApiService.getExecutiveDashboard({ ...dateRange, department }),
  });
    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {safeNumber(overallMetrics.totalTickets)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {safeToFixed(overallMetrics.averageResolutionTime)} jam
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {safeToFixed(safeNumber(overallMetrics.slaBreachRate) * 100)}%
            </div>
            <p className="text-xs text-muted-foreground">
              Persentase tiket yang melewati SLA
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {safeToFixed(overallMetrics.customerSatisfactionAvg)}/5
            </div>
            <p className="text-xs text-muted-foreground">
      ...
      <motion.div variants={itemVariants} className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Jumlah tiket baru dan diselesaikan dalam 30 hari terakhir
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="flex h-full flex-col justify-between">
                ...
                <div className="flex h-32 items-end justify-between">
                  {(trendsOverTime.dates || []).map((_, index) => {
                    const maxNewTickets = Math.max(
                      ...(trendsOverTime.newTickets || []),
                      1
                    );
                    const maxResolvedTickets = Math.max(
                      ...(trendsOverTime.resolvedTickets || []),
                      1
                    );
                    ...
                    return (
                      <div key={index} className="flex flex-col items-center">
                        <div
                          ...
                          style={{
                            height: `${
                              ((trendsOverTime.newTickets?.[index] || 0) /
                                maxNewTickets) *
                              100
                            }px`,
                          }}
                        ...
                        <div
                          ...
                          style={{
                            height: `${
                              ((trendsOverTime.resolvedTickets?.[index] || 0) /
                                maxResolvedTickets) *
                              100
                            }px`,
                          }}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Perbandingan kinerja antar departemen
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {(departmentPerformance || []).map((dept) => {
                ...
                return (
                  <div key={dept.department} className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        <span className="text-xs">
                          {safeNumber(dept.ticketCount)} tiket
                        </span>
                        <span className="flex items-center text-xs">
                          {safeNumber(dept.avgResolutionTime) <
                          safeNumber(overallMetrics.averageResolutionTime) ? (
                    ...
                    <Progress
                      value={
                        (safeNumber(dept.ticketCount) / maxTicketCount) * 100
                      }
                      className="h-2"
                    />
                  </div>
      ...
      <motion.div variants={itemVariants}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Performa staf berdasarkan jumlah tiket dan waktu penyelesaian
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-center">
                      <p className="text-sm font-medium">
                        {safeNumber(user.ticketsHandled)}
                      </p>
                      <p className="text-xs text-muted-foreground">Tiket</p>
                    </div>
                    <div className="text-center">
                      <p className="text-sm font-medium">
                        {safeToFixed(user.avgResolutionTime)} jam
                      </p>
                      <p className="text-xs text-muted-foreground">Rata-rata</p>
                    </div>
                    <div className="text-center">
                      <p className="text-sm font-medium">
                        {safeToFixed(user.satisfaction)}/5
                      </p>
          ...
          <TabsContent value="category" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribusi tiket berdasarkan kategori dan subkategori
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                        ...
                        <div key={index} className="space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs font-medium">
                              {safeNumber(category.count)} tiket
                            </span>
                          </div>
                          <Progress
                            value={
                              (safeNumber(category.count) / maxCount) * 100
                            }
                            className="h-2"
                          />
                        </div>
