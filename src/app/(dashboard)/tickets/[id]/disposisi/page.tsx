...
//   reason: z
//     .string()
//     .min(5, { message: "Alasan disposisi wajib diisi (min. 5 karakter)" }),
...
//           Tiket mungkin telah dihapus atau Anda tidak memiliki akses.
//         </p>
//         <Button asChild>
...
//       <DisposisiForm
//         ticketId={ticketId}
//         currentHandlerId={ticket.currentHandler}
//       />
//     </div>
//   );
// }
...
//   const [activeTab, setActiveTab] = useState<"forward" | "escalate" | "return">(
//     "forward"
//   );
...
//     useAvailableDosen(targetDepartment);
...
//         description:
//           "Terjadi kesalahan saat mendisposisi tiket. Silakan coba lagi.",
//         variant: "destructive",
//       });
//     }
//   };
...
//   const departments = [
//     ...new Set(availableUsers.map((user) => user.department)),
//   ].sort();
...
//           description:
//             "Eskalasi tiket ke tingkat yang lebih tinggi untuk mendapatkan perhatian lebih",
...
//           description:
//             "Kembalikan tiket ke pengguna sebelumnya untuk informasi lebih lanjut",
...
//                   </FormControl>
//                   <FormDescription>
//                     Berikan informasi tambahan yang mungkin berguna bagi
//                     penerima.
//                   </FormDescription>
//                   <FormMessage />
//                 </FormItem>
