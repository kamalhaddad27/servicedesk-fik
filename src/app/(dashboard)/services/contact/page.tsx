  ...
  return (
    <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      support@servicedesk.fik.upnvj.ac.id
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      <br />
                      Jl. RS. Fatmawati Raya, Pd. Labu, Kec. Cilandak, Jakarta
                      Selatan
                    </p>
                  </div>
                </div>
      ...
      <div className="rounded-lg border p-4">
        ...
        <p className="text-sm text-muted-foreground">
          Kami berusaha merespons semua pesan dalam waktu 24 jam kerja. Untuk
          masalah mendesak, silakan buat tiket dengan prioritas
          &quot;Urgent&quot;.
        </p>
      </div>
    </div>
